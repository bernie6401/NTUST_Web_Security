            ...
            <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;">
                ...
                <div class="dropdown">
                    <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                        <?php echo '<img src='.$row_result[avatar_id].' alt="" width="32" height="32" class="rounded-circle me-2">'; ?>
                        <?php echo '<strong>'.$row_result[username].'</strong>';?>
                    </a>
        ...
        <?php
            ...
            <div class="float-adjust p-3">
                <form name="form1" method="post" enctype="multipart/form-data">
                    ...
                    <input class="w-100 btn btn-lg btn-primary btn-adjust" type="submit" name="send_submit" value="SEND">
                </form>
            </div>';
        ?>
        </main>
        <script src="./js/bootstrap.bundle.min.js"></script>
        <script src="/js/post_sidebars.js"></script>
    </body>
</html>
